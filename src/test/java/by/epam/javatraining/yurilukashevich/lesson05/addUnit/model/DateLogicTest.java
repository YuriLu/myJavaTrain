...
public class DateLogicTest {
    ...
    public void testGetNextDayNegativeDay() {
        ...
        String actual = DateLogic.checkNextDay(day, month, year);
    ...
    @Test
    public void testNextDay30Month4() {
        int day = 30;
        int month = 4;
        int year = 1999;
    ...
    @Test
    public void testNextDay31Month4() {
        int day = 31;
        int month = 4;
        int year = 1999;
        String expected = "Incorrect input";
    ...
    @Test
    public void testNextDay29Month2LeapYear() {
        int day = 29;
        int month = 2;
        int year = 2000;
    ...
    @Test
    public void testNextDay29Month2ShortYear() {
        int day = 29;
        int month = 2;
        int year = 1999;
        String expected = "Incorrect input";
    ...
    @Test
    public void testNextDay28Month2ShortYear() {
        int day = 28;
        int month = 2;
        int year = 1999;
    ...
    @Test
    public void testNextDay28Month2LeapYear() {
        int day = 28;
        int month = 2;
        int year = 1600;
